      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-[#B1E5FF]/10 border-l-4 border-[#B1E5FF] rounded p-6 mb-12">
          ...
          <p className="text-[#9FA38F]">
            The economics are unusually strong due to current incentive structures,
            including the Investment Tax Credit, which is set to step down. We already
            have developer interest and indicative pricing in hand.
          </p>
        </div>
