    ...
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="h-12 flex items-center">
                <Image
                  src="/logos/watershed/watershed-horizontal-dark.svg"
                  alt="Watershed"
                  width={140}
                  height={42}
                  className="h-10 w-auto"
          ...
          <div className="bg-white/50 rounded-lg border-2 border-dashed border-[#9FA38F]/30 p-6 flex flex-col items-center justify-center min-h-[240px]">
            <div className="text-center">
              <svg className="w-12 h-12 text-[#9FA38F]/40 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-sm p-6 border border-[#9FA38F]/20">
            ...
            <div className="text-3xl font-light text-[#1A1A1A]">1</div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-[#9FA38F]/20">
            ...
            <div className="text-3xl font-light text-[#1A1A1A]">52</div>
          </div>
